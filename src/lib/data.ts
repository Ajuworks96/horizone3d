...
export interface MunicipalLocation {
  ...
  zone: string;
  type: string;
  coords: { x: number; y: number }; // SVG grid coordinates (%)
  ...
  locations: [
    {
      ...
      zone: "Central Multi-Modal Hub",
      type: "Primary Transit Terminal",
      coords: { x: 48, y: 52 },
      dailyFootfall: "High Daily Commuter Volume",
      mediaAvailable: ["LED Screen Billboards", "Bus-Stop Shelter Branding", "Waiting Benches", "Digital Signage"],
      keyHighlight: "The nerve center of municipal transit connecting intercity buses, local shuttles, and passenger flow.",
      dwellProfile: "12 - 25 min average commuter transit dwell",
    },
    {
      id: "loc-2",
      name: "East & West Temple Artery Corridors",
      zone: "High-Density Pedestrian Zone",
      type: "Civic & Pilgrim Promenade",
      coords: { x: 32, y: 36 },
      dailyFootfall: "Year-Round Pilgrims & Visitors",
      mediaAvailable: ["Translites / Clip-on Boards", "Street Advertising Pillars", "Waiting Benches", "Wayfinding Totems"],
      keyHighlight: "Prime heritage and pedestrian arteries experiencing dense, slow-moving crowds seven days a week.",
      dwellProfile: "Slow walking pace with constant eye-level view",
    },
    {
      id: "loc-3",
      name: "Municipal Ring Road & Bypass Arterial",
      zone: "Vehicular Transit Corridor",
      type: "Highway Arterial Junction",
      coords: { x: 74, y: 28 },
      dailyFootfall: "Heavy Inter-District Vehicular Traffic",
      mediaAvailable: ["Large Billboards", "LED Screen Billboards", "Unipoles"],
      keyHighlight: "High-speed and commuter vehicular artery with long line-of-sight approaches and zero obstruction.",
      dwellProfile: "High visual impact at traffic signal nodes",
    },
    {
      id: "loc-4",
      name: "Municipal Bus Stops & Feeder Shelters",
      zone: "Distributed Transit Grid",
      type: "Civic Commuter Network",
      coords: { x: 62, y: 72 },
      dailyFootfall: "Continuous Neighborhood Influx",
      mediaAvailable: ["Bus Stops with Hoardings", "Waiting Benches", "Backlit Boards"],
      keyHighlight: "Network of strategic passenger pick-up points distributed across essential residential and market gateways.",
      dwellProfile: "Repetitive daily impressions for local residents",
    },
